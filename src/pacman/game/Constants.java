...
public final class Constants
{
	...
	public enum MOVE 
	{
		...
		PAUSE   { public MOVE opposite(){return MOVE.PAUSE;		};},
		RESUME  { public MOVE opposite(){return MOVE.RESUME;	};},
		ADUP    { public MOVE opposite(){return MOVE.ADUP;	    };},
		ADRIGHT { public MOVE opposite(){return MOVE.ADRIGHT;	};},
		ADDOWN  { public MOVE opposite(){return MOVE.ADDOWN;	};},
		ADLEFT  { public MOVE opposite(){return MOVE.ADLEFT;	};},
		NOAD    { public MOVE opposite(){return MOVE.NOAD;	    };},
	...
	public static final int LEVEL_LIMIT=5000;//Integer.MAX_VALUE;//3000;				//time limit for a level
	public static final float GHOST_REVERSAL=0.0f;//0.0015f;		//probability of a global ghost reversal event
	...
	public static final int NUM_LIVES=1;//3;					//total number of lives Ms Pac-Man has (current + NUM_LIVES-1 spares)
